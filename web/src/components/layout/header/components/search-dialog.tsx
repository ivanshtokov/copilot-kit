        ...
        items: [
            {
                ...
                value: 'introduction',
                href: '/docs',
                keywords: 'getting started overview what is copilot kit'
            },
            {
                label: 'Installation',
                value: 'installation',
                href: '/docs/installation',
                keywords: 'install setup init npm npx global cli github'
            },
        ],
    },
    {
        ...
        items: [
            {
                ...
                value: 'agents',
                href: '/docs/agents',
                keywords: 'custom agents personas orchestrator reviewer security backend frontend copilot'
            },
            {
                label: 'Prompt Files',
                value: 'skills',
                href: '/docs/skills',
                keywords: 'prompt files templates reusable code generation review refactoring'
            },
            {
                label: 'Instructions',
                value: 'workflows',
                href: '/docs/workflows',
                keywords: 'instructions repository folder applyTo guidelines coding standards'
            },
        ],
    },
    {
        ...
        items: [
            {
                ...
                value: 'cli',
                href: '/docs/cli',
                keywords: 'command line interface init update status options copilot-kit'
            },
        ],
    },
];
