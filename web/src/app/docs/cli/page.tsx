                ...
                <div className="space-y-8">
                    ...
                    <div>
                        ...
                        <p className="text-base text-zinc-600 dark:text-zinc-400 mb-4">
                            Initialize Copilot Kit in your project by installing the <code className="px-1.5 py-0.5 rounded bg-zinc-100 dark:bg-zinc-800 text-sm font-mono">.github</code> folder structure.
                        </p>

                        <div className="relative group mb-4">
                            <pre className="p-4 rounded-lg bg-zinc-900 dark:bg-zinc-950 overflow-x-auto border border-zinc-800 font-mono text-sm">
                                <code className="text-zinc-100">npx @shtokov/copilot-kit init</code>
                            </pre>
                        </div>
                        ...
                        <div className="p-4 rounded-lg border border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900/50">
                            ...
                            <ul className="text-sm text-zinc-600 dark:text-zinc-400 space-y-1">
                                <li>• Creates <code className="px-1 py-0.5 rounded bg-zinc-200 dark:bg-zinc-800 font-mono text-xs">.github/</code> directory in current folder</li>
                                <li>• Downloads latest templates from GitHub</li>
                                <li>• Skips if <code className="px-1 py-0.5 rounded bg-zinc-200 dark:bg-zinc-800 font-mono text-xs">.github/</code> already exists (use <code className="px-1 py-0.5 rounded bg-zinc-200 dark:bg-zinc-800 font-mono text-xs">--force</code> to override)</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="relative group mb-4">
                            <pre className="p-4 rounded-lg bg-zinc-900 dark:bg-zinc-950 overflow-x-auto border border-zinc-800 font-mono text-sm">
                                <code className="text-zinc-100">npx @shtokov/copilot-kit update</code>
                            </pre>
                        </div>

                        <div className="p-4 rounded-lg border border-amber-200 dark:border-amber-900 bg-amber-50 dark:bg-amber-950/20">
                            <p className="text-sm text-amber-900 dark:text-amber-200">
                                <strong className="font-semibold">Warning:</strong> This will delete and replace your <code className="px-1 py-0.5 rounded bg-amber-100 dark:bg-amber-900/40 font-mono text-xs">.github/</code> folder. Make sure to backup any custom changes.
                            </p>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="relative group mb-4">
                            <pre className="p-4 rounded-lg bg-zinc-900 dark:bg-zinc-950 overflow-x-auto border border-zinc-800 font-mono text-sm">
                                <code className="text-zinc-100">npx @shtokov/copilot-kit status</code>
                            </pre>
                        </div>
                        ...
                        <div className="p-4 rounded-lg border border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900/50">
                            ...
                            <ul className="text-sm text-zinc-600 dark:text-zinc-400 space-y-1">
                                ...
                                <li>• Custom agents count</li>
                                <li>• Prompt files count</li>
                                <li>• Instructions count</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div className="space-y-6">
                    <div>
                        ...
                        <div className="relative group">
                            <pre className="p-4 rounded-lg bg-zinc-900 dark:bg-zinc-950 overflow-x-auto border border-zinc-800 font-mono text-sm">
                                <code className="text-zinc-100">npx @shtokov/copilot-kit init --force</code>
                            </pre>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="relative group">
                            <pre className="p-4 rounded-lg bg-zinc-900 dark:bg-zinc-950 overflow-x-auto border border-zinc-800 font-mono text-sm">
                                <code className="text-zinc-100">npx @shtokov/copilot-kit init --path ./my-project</code>
                            </pre>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="relative group">
                            <pre className="p-4 rounded-lg bg-zinc-900 dark:bg-zinc-950 overflow-x-auto border border-zinc-800 font-mono text-sm">
                                <code className="text-zinc-100">npx @shtokov/copilot-kit init --branch dev</code>
                            </pre>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="relative group">
                            <pre className="p-4 rounded-lg bg-zinc-900 dark:bg-zinc-950 overflow-x-auto border border-zinc-800 font-mono text-sm">
                                <code className="text-zinc-100">npx @shtokov/copilot-kit init --quiet --force</code>
                            </pre>
                        </div>
                    </div>
                </div>
